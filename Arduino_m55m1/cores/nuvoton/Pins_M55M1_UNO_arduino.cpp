...
#else
    {UART0, (uint32_t)UART0_MODULE, (uint32_t)(UART_USE_UART0), UART0_IRQn, {{20, SYS_GPB_MFP3_PB12MFP_UART0_RXD }, {21, SYS_GPB_MFP3_PB13MFP_UART0_TXD  }},  CLK_UARTSEL0_UART0SEL_HIRC, UART_CLKDIV_1},   //(T/R = PA7/PA6)
    //{UART1, (uint32_t)UART1_MODULE, (uint32_t)(UART_USE_UART1), UART1_IRQn, {{28, SYS_GPA_MFP0_PA2MFP_UART1_RXD }, {27, SYS_GPA_MFP0_PA3MFP_UART1_TXD  }},  CLK_CLKSEL1_UART1SEL_HIRC, UART_CLKDIV_1},   //(T/R = PA3/PA2)
