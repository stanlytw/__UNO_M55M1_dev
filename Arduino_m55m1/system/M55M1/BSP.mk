...
CHIP=M55M1
ARM_GCC_TOOLCHAIN=C:/Users/HLLIN6/AppData/Local/Arduino15/packages/nuvoton/tools/arm-none-eabi-gcc/10-2021q3/bin
PROJECT_BASE_PATH=C:/Users/HLLIN6/AppData/Local/Arduino15/packages/nuvoton/hardware/m55/1.0.1/system/$(CHIP)
...
vpath %.h $(CMSIS_DEVICE_PATH)/Nuvoton/$(CHIP)/Include $(CMSIS_ARM_PATH) $(CMSIS_STDDRIVER_PATH)/inc $(CMSIS_ARM_PATH) $(CMSIS_STDDRIVER_PATH)/inc/scu 
vpath %.c $(CMSIS_DEVICE_PATH)/Nuvoton/$(CHIP)/Source/ $(CMSIS_DEVICE_PATH)/Nuvoton/$(CHIP)/Source/GCC $(CMSIS_ARM_PATH) $(CMSIS_STDDRIVER_PATH)/src $(CMSIS_STDDRIVER_PATH)/src/scu 
...
VPATH+=$(CMSIS_STDDRIVER_PATH)/src/scu


INCLUDES = -I$(CMSIS_DEVICE_PATH)/Nuvoton/$(CHIP)/Include
INCLUDES += -I$(CMSIS_ARM_PATH)
INCLUDES += -I$(CMSIS_STDDRIVER_PATH)/inc
INCLUDES += -I$(CMSIS_STDDRIVER_PATH)/inc/scu
#INCLUDES += -I$(CMSIS_STDDRIVER_PATH)/inc/npu
...
C_SRC+=$(wildcard $(CMSIS_STDDRIVER_PATH)/src/scu/*.c)
C_SRC+=$(wildcard $(CMSIS_STDDRIVER_PATH)/src/npu/*.c)
